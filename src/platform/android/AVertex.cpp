...
Java_com_unknown_object_Vertex_nativeMakeVertex(JNIEnv *env, jclass clazz, jlong ndc_point_ptr,
    ...
    auto *position = ToNativePointer<NS_UNKNOWN::NdcPoint>(ndc_point_ptr);
    auto *uv = ToNativePointer<NS_UNKNOWN::TextureUVPoint>(uv_ptr);
    auto *color = ToNativePointer<NS_UNKNOWN::Color>(color_ptr);
...
Java_com_unknown_object_Vertex_nativeSetPosition(JNIEnv *env, jclass clazz, jlong ptr,
                                                 jlong ndc_point_ptr) {
    auto *position = ToNativePointer<NS_UNKNOWN::NdcPoint>(ndc_point_ptr);
    auto *vertex = ToNativePointer<NS_UNKNOWN::Vertex>(ptr);
