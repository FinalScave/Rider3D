function compile_vertex_windows() {
  ../tools/mac/shaderc -f "$1" --varyingdef "$2" -o "../src/core/shader/hlsl/$3" -i ./include --platform windows -p 150 --type vertex --bin2c "$4"
}
function compile_fragment_windows() {
  ../tools/mac/shaderc -f "$1" --varyingdef "$2" -o "../src/core/shader/hlsl/$3" -i ./include --platform windows -p 150 --type fragment --bin2c "$4"
}
