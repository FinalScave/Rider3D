function compile_vertex_windows() {
  ../tools/mac/shaderc -f "$1" --varyingdef "$2" -o "../src/core/shader/hlsl/$3" -i ./include --platform windows -p s_5_0 --type vertex --bin2c "$4"
}
function compile_fragment_windows() {
  ../tools/mac/shaderc -f "$1" --varyingdef "$2" -o "../src/core/shader/hlsl/$3" -i ./include --platform windows -p s_5_0 --type fragment --bin2c "$4"
}
function compile_vertex_mac() {
  ../tools/mac/shaderc -f "$1" --varyingdef "$2" -o "../src/core/shader/metal/$3" -i ./include --platform osx -p metal --type vertex --bin2c "$4"
}
function compile_fragment_mac() {
  ../tools/mac/shaderc -f "$1" --varyingdef "$2" -o "../src/core/shader/metal/$3" -i ./include --platform osx -p metal --type fragment --bin2c "$4"
}
function compile_vertex_android() {
  ../tools/mac/shaderc -f "$1" --varyingdef "$2" -o "../src/core/shader/glsl/$3" -i ./include --platform android --type vertex --bin2c "$4"
}
function compile_fragment_android() {
  ../tools/mac/shaderc -f "$1" --varyingdef "$2" -o "../src/core/shader/glsl/$3" -i ./include --platform android --type fragment --bin2c "$4"
}
